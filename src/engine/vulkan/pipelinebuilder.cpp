...
void PipelineBuilder::set_shaders(VkShaderModule vertexShader,
  ...
  _shaderStages.push_back(vkini::pipeline_shader_stage_create_info(
...
void PipelineBuilder::vertex_input(
    std::span<VkVertexInputBindingDescription> bindings,
    std::span<const VkVertexInputAttributeDescription> attributes) {
  _vertexInputInfo.vertexBindingDescriptionCount = bindings.size();
  _vertexInputInfo.vertexAttributeDescriptionCount = attributes.size();
  _vertexInputInfo.pVertexBindingDescriptions = bindings.data();
  _vertexInputInfo.pVertexAttributeDescriptions = attributes.data();
}
