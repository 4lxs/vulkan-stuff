...
constexpr VkCommandPoolCreateInfo command_pool_create_info(
...
constexpr VkCommandBufferAllocateInfo command_buffer_allocate_info(
...
constexpr VkFenceCreateInfo fence_create_info(VkFenceCreateFlags flags = 0) {
...
constexpr VkSubmitInfo2 submit_info(VkCommandBufferSubmitInfo* cmd,
...
constexpr VkPresentInfoKHR present_info() {
...
constexpr VkRenderingAttachmentInfo attachment_info(
...
constexpr VkRenderingAttachmentInfo depth_attachment_info(
    VkImageView view,
    VkImageLayout layout = VK_IMAGE_LAYOUT_COLOR_ATTACHMENT_OPTIMAL) {
...
constexpr VkRenderingInfo rendering_info(
...
constexpr VkDescriptorSetLayoutBinding descriptorset_layout_binding(
...
constexpr VkDescriptorSetLayoutCreateInfo descriptorset_layout_create_info(
...
constexpr VkWriteDescriptorSet write_descriptor_image(
...
constexpr VkWriteDescriptorSet write_descriptor_buffer(
    VkDescriptorType type, VkDescriptorSet dstSet,
...
constexpr VkDescriptorBufferInfo buffer_info(VkBuffer buffer,
                                             VkDeviceSize offset,
                                             VkDeviceSize range) {
...
constexpr VkImageCreateInfo image_create_info(VkFormat format,
...
constexpr VkImageViewCreateInfo imageview_create_info(
